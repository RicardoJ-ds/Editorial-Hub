...
- **Generated:** 2026-07-17 20:18:02 UTC
- **Source:** live BigQuery `INFORMATION_SCHEMA` + curated lineage
- **Inventory:** 39 tables · 23 views · 12 read by the Planning Hub
...
*one row per monitored article · 3,372 rows · fresh 2026-07-17 11:52:30 UTC*
...
*one row per revision · 3,716 rows · fresh 2026-07-17 11:52:30 UTC*
...
*article × editor · 16,312 rows · fresh 2026-07-17 11:52:30 UTC*
...
*year × month × week · 52 rows · fresh 2026-07-17 11:52:30 UTC*
...
*pod × month × version · 305 rows · fresh 2026-07-17 11:52:30 UTC*
...
*member × month · 417 rows · fresh 2026-07-17 11:52:30 UTC*
...
*client × month · 513 rows · fresh 2026-07-17 11:52:30 UTC*
...
*one row per client · 85 rows · fresh 2026-07-17 11:52:30 UTC*
...
*one row per client · 51 rows · fresh 2026-07-17 11:52:30 UTC*
...
*client × month · 653 rows · fresh 2026-07-17 11:52:30 UTC*
...
*delivery template rows · 60 rows · fresh 2026-07-17 11:52:30 UTC*
...
### `editorial_raw_goals`
*client × month × week × content_type · 2,217 rows · fresh 2026-07-17 11:52:30 UTC*
...
*member × month × kpi_type · 1,481 rows · fresh 2026-07-17 11:52:30 UTC*
...
*model assumption rows · 14 rows · fresh 2026-07-17 11:52:30 UTC*
...
*kind × raw_name · 471 rows · fresh 2026-07-17 11:52:30 UTC*
...
*year × month × kind × pod × client × role × person · 17,328 rows · fresh 2026-07-17 11:52:30 UTC*
...
*client × month · 4,560 rows · fresh 2026-07-17 11:52:30 UTC*
...
*Surfer API usage rows · 25 rows · fresh 2026-07-17 11:52:30 UTC*
...
*one row per team member · 12 rows · fresh 2026-07-17 11:52:30 UTC*
...
*editor × client × creation-month · 1,834 rows · fresh 2026-07-17 11:52:30 UTC*
...
*revision × month · 781 rows · fresh 2026-07-17 11:52:30 UTC*
...
*pod × month × version · 105 rows · fresh 2026-07-17 11:52:30 UTC*
...
*client × month · 4,561 rows · fresh 2026-07-17 11:52:30 UTC*
...
*client × pod × month · 425 rows · fresh 2026-07-17 11:52:30 UTC*
...
*client × month × content_type · 510 rows · fresh 2026-07-17 11:52:30 UTC*
...
*member × pod × month · 303 rows · fresh 2026-07-17 11:52:30 UTC*
...
*one row per member · 12 rows · fresh 2026-07-17 11:52:30 UTC*
...
*one row per flagged/rewrite article · 378 rows · fresh 2026-07-17 11:52:30 UTC*
...
*member × month · 303 rows · fresh 2026-07-17 11:52:30 UTC*
...
*year × month × pod × client × role × person · 2,551 rows · fresh 2026-07-17 11:52:30 UTC*
...
- **Pipeline:** etl/warehouse/v_editorial_production_committed.sql (standalone always-live CREATE VIEW; applied manually like v_editorial_roster — reads a hub-published table outside this ETL's publish)
...
- **Editorial Hub:** bq_dashboard production_trend / client_production / list_clients end-date → Production History chart, client-production timeline, client end-date
- **Planning Hub:** —
- **Columns:** `id`, `client_id`, `year`, `month`, `updated_at`, `articles_actual`, `articles_projected`, `projected_original` …
...
- **Planning Hub:** —
- **Columns:** `pod`, `role`, `home_pod`, `ym`, `member`, `email`, `capacity`, `base_capacity` …

### `editorial_writer_desired`
*writer × ym (latest submission wins) · 285 rows*
