...
import { ArrowLeftToLine, BookOpen, ScrollText, X } from "lucide-react";
...
export function HelpModal({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-3xl border-[#2a2a2a] bg-[#0a0a0a] p-0 sm:rounded-lg overflow-hidden">
        ...
        <Tabs defaultValue={initialTab} className="flex flex-col">
          <TabsList
            variant="line"
            className="mx-4 mt-3 mb-0 self-start"
          >
